...
export function EmotionAvatar({ participant }: { participant: Participant }) {
  ...
  return (
    <div className="emotion-avatar" data-emotion={participant.emotion} data-style={participant.avatarStyle} data-skin-tone={participant.skinTone} role="img" aria-label={`${participant.displayName} is feeling ${emotion.label.toLowerCase()}. ${emotionSpeech[participant.emotion]}`}>
      ...
      <div className="avatar-character-frame" aria-hidden="true">
